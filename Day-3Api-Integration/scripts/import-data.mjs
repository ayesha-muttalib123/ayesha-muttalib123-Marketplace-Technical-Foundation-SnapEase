...
// Debugging: Check environment variables after loading .env
console.log('Project ID:', process.env.NEXT_PUBLIC_SANITY_PROJECT_ID); // Should not be undefined
console.log('Dataset:', process.env.NEXT_PUBLIC_SANITY_STUDIO_DATASET);       // Should not be undefined
console.log('Token:', process.env.NEXT_PUBLIC_SANITY_API_TOKEN);                   // Should not be undefined
